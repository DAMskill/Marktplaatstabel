...
// Using raw-boy because the combined use of middleware bodyParser and transformerProxy
...
var USER_AGENT      = 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.125 Safari/537.36';
...
var ACCEPT_LANGUAGE = 'nl-NL,nl;q=0.8,en-US;q=0.6,en;q=0.4';
var CONNECTION      = 'Closed';

/* Upload url */
var TARGET_HOST     = 'www.marktplaats.nl';
var TARGET_PATH     = '/syi/uploadImage.html?nl.marktplaats.xsrf.token=';
    ...
    if (fileData!==null) {
        ...
        var post_req = https.request(postOptions, function(res) {
              ...
              res.on('data', function (data) {
                    _this.request.emit("photoUploaderResult", data);
              });
