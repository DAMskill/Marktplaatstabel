...
pkgbuild --root "../Package folder" --scripts "../Package scripts" --version 2.4.3 --install-location /Applications/Marktplaatstabel.app Marktplaatstabel-2.4.3.pkg --identifier nl.marktplaatstabel
